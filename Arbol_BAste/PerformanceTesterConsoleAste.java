...
public class PerformanceTesterConsoleAste {
    private static final String OUTPUT_FILE = "performance_results(new3).txt";
    private ArbolAste arbol;

    private Map<String, List<Long>> operationTimes;

    public PerformanceTesterConsoleAste(ArbolAste arbol) {
        this.arbol = arbol;
    ...
    private void showTop10() {
        System.out.println("\033[34mB* \033[0m"+"\033[33mTop 10 Tiempos para cada Operacion:\033[0m");
    ...
    private void showAverageTimes() {
        System.out.println("\033[34mB* \033[0m"+"\033[33mTiempos Promedio para cada Operacion:\033[0m");
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(OUTPUT_FILE, true))) {
    ...
    private void showTotalTimes() {
        System.out.println("\033[34mB* \033[0m"+"\033[33mTiempos Totales para cada Operacion:\033[0m");
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(OUTPUT_FILE, true))) {
