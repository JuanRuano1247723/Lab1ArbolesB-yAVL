...
public class AppBAste {

    private String filePath;
    private int grado;
    private ArbolAste arbol;
    private PerformanceTesterAste tester;
    private PerformanceTesterConsoleAste testerc;

    public AppBAste(String filePath, int grado) {
        this.filePath = filePath;
        this.grado = grado;
        this.arbol = new ArbolAste(grado);
        this.tester = new PerformanceTesterAste(arbol);
        this.testerc = new PerformanceTesterConsoleAste(arbol);
