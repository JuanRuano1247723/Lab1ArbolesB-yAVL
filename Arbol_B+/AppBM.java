...
public class AppBM {
    ...
    private PerformanceTesterBM tester;
    private PerformanceTesterConsoleBM testerc;

    public AppBM(String filePath, int grado) {
        this.filePath = filePath;
        this.grado = grado;
        this.arbol = new ArbolBM(grado);
        this.tester = new PerformanceTesterBM(arbol);
        this.testerc = new PerformanceTesterConsoleBM(arbol);
