...
public class AppB {
    ...
    private PerformanceTesterB tester;
    private PerformanceTesterConsoleB testerc;

    public AppB(String filePath, int grado) {
        this.filePath = filePath;
        this.grado = grado;
        this.arbol = new ArbolB(grado);
        this.tester = new PerformanceTesterB(arbol);
        this.testerc = new PerformanceTesterConsoleB(arbol);
